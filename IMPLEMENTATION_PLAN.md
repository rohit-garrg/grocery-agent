...
- [ ] **A-SIMPLIFY: Code health pass for Phase A.** Review all source files in `src/` created during Phase A (master_list_manager, selection_parser, match_utils, optimizer, formatter). Simplify without changing behavior. See PROMPT.md "SIMPLIFY tasks" rules.
